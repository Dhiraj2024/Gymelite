...
const AddTrainer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to admin dashboard trainers tab
      navigate("/admin-dashboard?tab=trainers");
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-dark-tertiary border border-primary/30 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary"
                required
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g., Weight Loss, Strength, Yoga"
                className="w-full bg-dark-tertiary border border-primary/30 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="5"
                className="w-full bg-dark-tertiary border border-primary/30 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary resize-none"
              />
            </div>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <button
                ...
                className="flex-1 btn-outline-neon"
              >
                Cancel
              </button>
            </div>
